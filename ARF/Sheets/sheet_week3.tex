...
\subsection{A is measurable if and only if \texorpdfstring{$\chi_A$}{the indicator function of A} is a measurable function}
...
\subsection{Canonical form of simple function}
